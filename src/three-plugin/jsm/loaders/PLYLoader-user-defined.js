  ...
  parse(data) {
    ...
    function handleElement(buffer, elementName, element) {
      ...
      if (elementName === "vertex") {
        ...
        if (attrR !== null && attrG !== null && attrB !== null) {
          // 获取平面
          vertex_indices.forEach((indices) => {
            _color
              .setRGB(
                element[attrR] / 255.0,
                element[attrG] / 255.0,
            ...
            if (!buffer.colors[indices * 3]) {
              buffer.colors[indices * 3] = _color.r;
              buffer.colors[indices * 3 + 1] = _color.g;
              buffer.colors[indices * 3 + 2] = _color.b;
            }
          });
        }
      }
