...
class CameraHelper extends LineSegments {
  constructor(camera) {
    ...
    // const colorCross = new Color(0x333fff);

    const colorFrustum = new Color(0xffaa00);
    const colorCone = new Color(0xF92E3B);
    const colorUp = new Color(0x73B7FF);
    const colorTarget = new Color(0x00DD67);
    const colorCross = new Color(0x73B7FF);
