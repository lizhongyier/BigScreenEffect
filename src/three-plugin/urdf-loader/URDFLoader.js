...
import { STLLoader } from "@bus/assets/three-plugin/jsm/loaders/STLLoader.js";
import { ColladaLoader } from "@bus/assets/three-plugin/jsm/loaders/ColladaLoader.js";
import { modelLoaderPlyByUrl } from "@bus/utils/3d/modelLoader";
import { getMetalBrightMaterial } from "@bus/utils/3d/robotArm";
import {
  URDFRobot,
  URDFJoint,
  URDFLink,
...
export default class URDFLoader {
  ...
  parse(content) {
    ...
    function processMaterial(node) {
      ...
      const material = getMetalBrightMaterial();
    ...
    function processLinkElement(vn, materialMap = {}) {
      ...
      if (materialNode) {
        ...
        material = getMetalBrightMaterial();
      }
      ...
      children.forEach((n) => {
        ...
        if (type === "geometry") {
          ...
          if (geoType === "mesh") {
            ...
            const radius =
              parseFloat(n.children[0].getAttribute("radius")) || 0;
            primitiveModel.scale.set(radius, radius, radius);

            group.add(primitiveModel);
          } else if (geoType === "cylinder") {
            const primitiveModel = new THREE.Mesh();
            primitiveModel.geometry = new THREE.CylinderBufferGeometry(
              1,
              1,
              1,
              30
            ...
            const radius =
              parseFloat(n.children[0].getAttribute("radius")) || 0;
            const length =
              parseFloat(n.children[0].getAttribute("length")) || 0;
